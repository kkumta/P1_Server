...
PROTOBUF_CONSTEXPR C_JOIN::C_JOIN(
    ...
    /*decltype(_impl_.joininfo_)*/nullptr
...
PROTOBUF_CONSTEXPR C_ATTACK::C_ATTACK(
  ...
  , /*decltype(_impl_.attacked_object_id_)*/uint64_t{0u}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::C_JOIN, _impl_.joininfo_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_LOGIN, _impl_.logininfo_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_ATTACK, _impl_.attacking_object_id_),
  PROTOBUF_FIELD_OFFSET(::Protocol::C_ATTACK, _impl_.attacked_object_id_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 84, -1, -1, sizeof(::Protocol::C_ATTACK)},
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Struct.proto\".\n\006C_JOIN\022$\n\010joinInfo\030\001 \001(\013"
  "2\022.Protocol.JoinInfo\"\031\n\006S_JOIN\022\017\n\007succes"
  "s\030\001 \001(\010\"1\n\007C_LOGIN\022&\n\tloginInfo\030\001 \001(\0132\023."
  "Protocol.LoginInfo\",\n\007S_LOGIN\022\017\n\007success"
  "\030\001 \001(\010\022\020\n\010nickname\030\002 \001(\t\" \n\014C_ENTER_GAME"
  "\022\020\n\010nickname\030\002 \001(\t\"E\n\014S_ENTER_GAME\022\017\n\007su"
  ...
  "PosInfo\")\n\006S_MOVE\022\037\n\004info\030\001 \001(\0132\021.Protoc"
  "ol.PosInfo\"C\n\010C_ATTACK\022\033\n\023attacking_obje"
  "ct_id\030\001 \001(\004\022\032\n\022attacked_object_id\030\002 \001(\004\""
  "0\n\010S_ATTACK\022$\n\004info\030\001 \001(\0132\026.Protocol.Cre"
  "atureInfo\"\025\n\006C_CHAT\022\013\n\003msg\030\001 \001(\t\"\'\n\006S_CH"
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 721, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
...
class C_JOIN::_Internal {
 public:
  static const ::Protocol::JoinInfo& joininfo(const C_JOIN* msg);
};

const ::Protocol::JoinInfo&
C_JOIN::_Internal::joininfo(const C_JOIN* msg) {
  return *msg->_impl_.joininfo_;
}
void C_JOIN::clear_joininfo() {
  if (GetArenaForAllocation() == nullptr && _impl_.joininfo_ != nullptr) {
    delete _impl_.joininfo_;
  }
...
C_JOIN::C_JOIN(const C_JOIN& from)
  ...
  if (from._internal_has_joininfo()) {
    _this->_impl_.joininfo_ = new ::Protocol::JoinInfo(*from._impl_.joininfo_);
  }
  // @@protoc_insertion_point(copy_constructor:Protocol.C_JOIN)
}

inline void C_JOIN::SharedCtor(
...
inline void C_JOIN::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete _impl_.joininfo_;
}
...
const char* C_JOIN::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ptr = ctx->ParseMessage(_internal_mutable_joininfo(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* C_JOIN::_InternalSerialize(
  ...
  // .Protocol.JoinInfo joinInfo = 1;
  if (this->_internal_has_joininfo()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(1, _Internal::joininfo(this),
        _Internal::joininfo(this).GetCachedSize(), target, stream);
  }
...
void C_JOIN::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<C_JOIN*>(&to_msg);
  ...
  if (from._internal_has_joininfo()) {
    _this->_internal_mutable_joininfo()->::Protocol::JoinInfo::MergeFrom(
        from._internal_joininfo());
  }
...
void C_JOIN::InternalSwap(C_JOIN* other) {
  ...
  swap(_impl_.joininfo_, other->_impl_.joininfo_);
}
...
class C_LOGIN::_Internal {
 public:
  static const ::Protocol::LoginInfo& logininfo(const C_LOGIN* msg);
};

const ::Protocol::LoginInfo&
C_LOGIN::_Internal::logininfo(const C_LOGIN* msg) {
  return *msg->_impl_.logininfo_;
}
void C_LOGIN::clear_logininfo() {
...
C_LOGIN::C_LOGIN(const C_LOGIN& from)
  ...
  if (from._internal_has_logininfo()) {
    _this->_impl_.logininfo_ = new ::Protocol::LoginInfo(*from._impl_.logininfo_);
  }
...
void C_LOGIN::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_logininfo()) {
    _this->_internal_mutable_logininfo()->::Protocol::LoginInfo::MergeFrom(
...
C_ATTACK::C_ATTACK(const C_ATTACK& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.attacked_object_id_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.attacking_object_id_, &from._impl_.attacking_object_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.attacked_object_id_) -
    reinterpret_cast<char*>(&_impl_.attacking_object_id_)) + sizeof(_impl_.attacked_object_id_));
...
// @@protoc_insertion_point(message_clear_start:Protocol.C_ATTACK)
  ...
  ::memset(&_impl_.attacking_object_id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.attacked_object_id_) -
      reinterpret_cast<char*>(&_impl_.attacking_object_id_)) + sizeof(_impl_.attacked_object_id_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _impl_.attacked_object_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* C_ATTACK::_InternalSerialize(
  ...
  // uint64 attacked_object_id = 2;
  if (this->_internal_attacked_object_id() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(2, this->_internal_attacked_object_id(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.C_ATTACK)
  ...
  // uint64 attacked_object_id = 2;
  if (this->_internal_attacked_object_id() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_attacked_object_id());
  }
...
void C_ATTACK::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_attacked_object_id() != 0) {
    _this->_internal_set_attacked_object_id(from._internal_attacked_object_id());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void C_ATTACK::InternalSwap(C_ATTACK* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(C_ATTACK, _impl_.attacked_object_id_)
      + sizeof(C_ATTACK::_impl_.attacked_object_id_)
      - PROTOBUF_FIELD_OFFSET(C_ATTACK, _impl_.attacking_object_id_)>(
...
class S_ATTACK::_Internal {
 public:
  static const ::Protocol::CreatureInfo& info(const S_ATTACK* msg);
};
...
S_ATTACK::S_ATTACK(const S_ATTACK& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_info()) {
    _this->_impl_.info_ = new ::Protocol::CreatureInfo(*from._impl_.info_);
  }
...
void S_ATTACK::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_info()) {
    _this->_internal_mutable_info()->::Protocol::CreatureInfo::MergeFrom(
        from._internal_info());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
